...
export class CreateFormComponentsTable1722197021196
  implements MigrationInterface
{
  name = 'CreateFormComponentsTable1722197021196';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "form_components" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "subtitle" character varying, "type" "public"."form_components_type_enum" NOT NULL, "required" boolean NOT NULL, "form_id" uuid NOT NULL, CONSTRAINT "PK_4fa78917422bd86e5ddd4796707" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
